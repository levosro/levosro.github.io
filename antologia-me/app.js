    ...
    function (value) {
      ...
      if (x != undefined) {
        ...
        document.getElementById('download').addEventListener('click', function () {
          downloadFile('./Antologia Marx-Engels.epub', 'Antologia Marx-Engels.epub')
        })
...
async function openButton(text, btnX, i) {
  ...
  noteZone.innerHTML = res;
  if (window.speechSynthesis.getVoices().filter(item => item.lang.includes('ro')).length > 0) {
