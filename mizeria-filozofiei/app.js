  ...
  myPromise.then(
    function (value) {
      ...
      if (x != undefined) {
        ...
        // res = res + '<ul>'
        res = res + `<div style="text-align: center;" class="dt"><b><a href="./index.html?id=C1.01" id="a1">Mizeria filozofiei</a></b></div>`;
        ...
        document.getElementById('download').addEventListener('click', function () {
          downloadFile('./Mizeria filozofiei.epub', 'Mizeria filozofiei.epub')
        })
...
function generateTOC() {
  ...
  res = res + '<div id="toc">'
  res = res + '<menuitem><menuitem> <span class="heading"><a href="./index.html" id="A0.0"><i class="fa fa-book"></i> Mizeria filozofiei</a></span> </menuitem>';
  for (let j = 0; j < texts.length; j++) {
    let text = texts[j];
